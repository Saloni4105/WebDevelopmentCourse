// Higher Order and arrow function
...
// Write a function findLongestWord(arr) that takes an array of strings and returns the longest word 
// using reduce() and an arrow function
